...
// Welcome message - asks player for their name and if they want play
...
function movePlayer(board, playerPos, direction) {
    ...
    // Checks collisions - If the player collides, loses a life - If player runs out of them --> 'Game over ...' - If right move player can continue until they lose or win
